        ...
        <div className="w-full mt-9 flex flex-col items-start justify-start px-5">
          ...
          <div className="w-full flex flex-col items-start justify-start gap-3">
            <p className="text-white-200 text-[14px] font-ppReg">
              ...
              their eLearn portal login details with other students or vendors.
              They do this to solve problems, access Tutor Marked Assessments
              (TMA), or for other reasons.
            </p>
            <p className="text-white-200 text-[14px] font-ppReg">
            ...
            <p className="text-white-200 text-[14px] font-ppReg">
              Recognizing this problem, I took the initiative to create a secure
              application. This app allows students to access the eLearn
              platform of their peers without having to share their
          ...
          <div className="w-full mt-2 flex flex-col items-start justify-start gap-3">
            ...
            <p className="text-white-200 text-[14px] font-ppReg">
              ...
              encryption algorithm and a secret key stored on the server before
              storage. However, it's important to note that even with these
              security measures, there is still a potential risk. If you grant
              access to your portal and someone copies your logged-in session
              ID, they could potentially use it later, especially if they have
              some technical knowledge.
            </p>
            <p className="text-white-200 text-[14px] font-ppReg">
              As a precaution, I would recommend generating a nocred URL with a
              1-day expiration to minimize the risk of the link being used
          ...
          <p className="text-white-200 text-[14px] font-ppReg">
            ...
            <a href={nocredExtRelease} className="text-green-400 underline">
              github release
            </a>
            . After downloading, Open your default PC browser, for me, it brave.
            Navigate to the puzzle icon at top right corner of the browser,
            click on that icon and select{" "}
          ...
          <p className="text-white-200 text-[14px] font-ppReg">
            ...
            Note!! You have to unzip the assets before uploading to chrome.After
            that simply select the extracted extensions folder as seen below
          </p>
          <img
          ...
          <p className="text-white-200 text-[14px] font-ppReg">
            ...
            Once it has been uploaded and loaded correctly without no errors, it
            should look as the picture shown below
          </p>
          <img
          ...
          <p className="text-white-200 text-[14px] font-ppReg">
            ...
            To make the extention more assessible, you can pin the extention by
            following the picture guide below
          </p>
          <img
